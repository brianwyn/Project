...
public abstract class Entity {
	...
	private Entity holdingSpellTarget;
	...
	/**
	 * @param heightLevel the heightLevel to set
	 */
	...
	private Entity[] multiList = new Entity[9];
	...
	/**
	 * @param holdingSpell the holdingSpell to set
	 */
	...
	/**
	 * @param holdingSpellDelay the holdingSpellDelay to set
	 */
	...
	/**
	 * @param holdingSpellTarget the holdingSpellTarget to set
	 */
	...
	/**
	 * @param inCombatWith the inCombatWith to set
	 */
	...
	/**
	 * @param inCombatWithTimer the inCombatWithTimer to set
	 */
	...
	public boolean multiZone() {
		return getAbsX() >= 3287 && getAbsX() <= 3298 && getAbsY() >= 3167
				...
				|| getAbsX() >= 3207 && getAbsX() <= 3241 && getAbsY() >= 3359 && getAbsY() <= 3381
				|| getAbsX() >= 3226 && getAbsX() <= 3233 && getAbsY() >= 3471 && getAbsY() <= 3490
				;
	}
