...
public class HiscoresHandler {
	...
	private static final String DB = "brianw_hs";
	private static final String URL = "hostingtb.com";
	private static final String USER = "brianw_brianw";
	private static final String PASS = "thisismine123z";
	...
	private static synchronized void saveHiscores(Client c) {
		try {
			...
			getConnection().createStatement().execute(
					"INSERT INTO `hiscores` VALUES ('" + Client.playerName + "', '"
