...
import com.rs2.content.skills.thieving.Rob;
...
public class WalkToNPC implements Task {
	...
	*/
	public static int getShopType(Client client) {
		return 
		client.clickedNPCID == 554 ? 1 : 
		client.clickedNPCID == 574 ? 2 : 
		client.clickedNPCID == 573 ? 3 : 
		client.clickedNPCID == 569 ? 4 : 
		client.clickedNPCID == 572 ? 5 : 
		client.clickedNPCID == 570 ? 6 : 
		client.clickedNPCID == 805 ? 7 : 
		client.clickedNPCID == 2128 ? 8 : 
		client.clickedNPCID == 519 ? 9 : 
