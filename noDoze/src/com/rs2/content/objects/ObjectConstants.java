...
public interface ObjectConstants {
	...
	public static final int
		...
		BANK = 3,
		DOOR = 999,
		TREE = PlayerConstants.WOODCUTTING,
		FISH = PlayerConstants.FISHING,
		MINE = PlayerConstants.MINING,
		GEM_CRAFT = PlayerConstants.CRAFTING,
		ORE_SMELTING = PlayerConstants.SMITHING,
		DUMMY = 823,
		MOULD_CRATE = 9535,
		JUG = 1935,
		DEPOSIT_BOX = 9398,
		TELE_KINETIC = 10778,
		TELE_GRAVEYARD = 10781,
		TELE_ENCHANTERS = 10779,
		TELE_VARROCK = 13622,
		CHAOS_ALTAR = 61,
		ALTAR = 409,
		ANCIENT_ALTAR = 6552,
		TELE_JAD = 10780,
		MAGIC_DOOR = 10721,
		MAGIC_STAIR_CASE_1_DOWN = 10773,
		MAGIC_STAIR_CASE_1_UP = 10771,
		MAGIC_STAIR_CASE_2_DOWN = 10776,
		MAGIC_STAIR_CASE_2_UP = 10775,
		FIGHT_PIT_WAITING_ROOM = 9369,
		FIGHT_PIT_WAITING_ROOM2 = 9368,
		VIEWING_ORB = 9391,
		FIRST_DUNGEON_EXIT = 6450,
		FIRST_DUNGEON_ENTRY = 10321,
		TEA_STALL = 635,
		STR_DOOR = 1531,
		HAY_STACK = 299,
		CHICKEN_DOOR1 = 2051,
		CHICKEN_DOOR2 = 2050,
		JAIL_EXIT = 6836,
		KARAMJA_ROPE_DOWN = 492,
		KARAMJA_ROPE_UP = 1764,
		TZ_HAAR_ENTRY = 9358,
		TZ_HAAR_EXIT = 9359,
		OBELISK0 = 14831,
		OBELISK1 = 14830,
	...
	public int[][] objectCommander = {
		...
		{ 11666, GEM_CRAFT, 2, 500},
		{ 11666, ORE_SMELTING, 2, 500},
		{ 2643, ORE_SMELTING, 2, 500},
		{ 9534 , MOULD_CRATE, 1, 500},
		{ 873, JUG, 2, 500},
		{ 874, JUG, 2, 500},
		{ 879, JUG, 2, 500},
		{ 880, JUG, 2, 500},
